...
## Design
![alt text](https://github.com/springboot-microservices-project/.github/blob/main/profile/page/transaction-service/transaction-service-design.png?raw=true)
...
spring:
  ...
  # mysql
  datasource:
    url: jdbc:mysql://localhost:3312/db_transaction
    username: user
    password: password
