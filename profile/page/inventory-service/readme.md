...
## Design
![alt text](https://github.com/springboot-microservices-project/.github/blob/main/profile/page/inventory-service/inventory-service-design.png?raw=true)
...
spring:
  ...
  # mysql
  datasource:
    url: jdbc:mysql://localhost:3314/db_inventory
    username: user
    password: password
